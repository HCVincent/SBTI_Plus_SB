window.SBTI_TEXTS = {
  ui: {
      ...
      detail: {
        navTitle: '__GEMINI__ 详情侧栏导航标题，类似16P的Explore This Type但用本站的损、丧语气写',
  ...
  typeLibrary: {
    "CTRL": {
            ...
            "friendships": {
              "title": "FRIENDSHIPS",
              "lead": "__GEMINI__ 友情导语：这种人格怎么交朋友、和朋友相处是什么体感、最容易把友情搞成什么样。写3到5句话。",
              "callout": "__GEMINI__ 一句扎心的话总结这种人格在友情里最鲜明的bug或亮点。",
              "sections": [
                { "heading": "__GEMINI__ 友情特征一小标题4到8字", "body": "__GEMINI__ 友情核心表现之一：相处方式、朋友体感、典型场景。写2到4句话。" },
                { "heading": "__GEMINI__ 友情特征二小标题4到8字", "body": "__GEMINI__ 友情核心表现之二：雷区翻车或意外闪光。写2到4句话。" }
              ]
            },
            "romanticRelationships": {
              "title": "ROMANTIC RELATIONSHIPS",
              "lead": "__GEMINI__ 恋爱导语：这种人格怎么谈恋爱、另一半体感如何、最容易把感情搞成什么样。写3到5句话。",
              "callout": "__GEMINI__ 一句扎心的话总结这种人格在恋爱里最致命的死穴或最头疼的特征。",
              "sections": [
                { "heading": "__GEMINI__ 恋爱特征一小标题4到8字", "body": "__GEMINI__ 恋爱核心模式之一：对恋人方式、体感、翻车情境。写2到4句话。" },
                { "heading": "__GEMINI__ 恋爱特征二小标题4到8字", "body": "__GEMINI__ 恋爱核心表现之二：死穴场景或私下柔软。写2到4句话。" }
              ]
            }
          },
    "ATM-er": {
